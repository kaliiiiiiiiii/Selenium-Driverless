...
class RemoteObject:
    ...
    def from_json(cls, json: T_JSON_DICT) -> RemoteObject:
        return cls(
            ...
            value=json['value'] if json.get('value', None) is not None else None,
            unserializable_value=UnserializableValue.from_json(json['unserializableValue']) if json.get(
                'unserializableValue', None) is not None else None,
            description=str(json['description']) if json.get('description', None) is not None else None,
            web_driver_value=WebDriverValue.from_json(json['webDriverValue']) if json.get('webDriverValue',
            ...
            custom_preview=CustomPreview.from_json(json['customPreview']) if json.get('customPreview',
                                                                                      None) is not None else None,
        )
...
class CustomPreview:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CustomPreview:
        return cls(
            ...
            body_getter_id=RemoteObjectId.from_json(json['bodyGetterId']) if json.get('bodyGetterId',
                                                                                      None) is not None else None,
        )
...
class ObjectPreview:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ObjectPreview:
        return cls(
            ...
            subtype=str(json['subtype']) if json.get('subtype', None) is not None else None,
            description=str(json['description']) if json.get('description', None) is not None else None,
            entries=[EntryPreview.from_json(i) for i in json['entries']] if json.get('entries',
                                                                                     None) is not None else None,
        )
...
class PropertyPreview:
    ...
    def from_json(cls, json: T_JSON_DICT) -> PropertyPreview:
        return cls(
            ...
            value_preview=ObjectPreview.from_json(json['valuePreview']) if json.get('valuePreview',
                                                                                    None) is not None else None,
            subtype=str(json['subtype']) if json.get('subtype', None) is not None else None,
        )
...
class ExceptionDetails:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ExceptionDetails:
        return cls(
            ...
            execution_context_id=ExecutionContextId.from_json(json['executionContextId']) if json.get(
                'executionContextId', None) is not None else None,
            exception_meta_data=dict(json['exceptionMetaData']) if json.get('exceptionMetaData',
                                                                            None) is not None else None,
        )
...
class StackTraceId:
    ...
    def from_json(cls, json: T_JSON_DICT) -> StackTraceId:
        return cls(
            id_=str(json['id']),
            debugger_id=UniqueDebuggerId.from_json(json['debuggerId']) if json.get('debuggerId',
                                                                                   None) is not None else None,
        )
...
def get_properties(
    ...
    typing.List[PropertyDescriptor], typing.Optional[typing.List[InternalPropertyDescriptor]], typing.Optional[
        typing.List[PrivatePropertyDescriptor]], typing.Optional[ExceptionDetails]]]:
    '''
    ...
    return (
        ...
        [InternalPropertyDescriptor.from_json(i) for i in json['internalProperties']] if json.get('internalProperties',
                                                                                                  None) is not None else None,
        [PrivatePropertyDescriptor.from_json(i) for i in json['privateProperties']] if json.get('privateProperties',
                                                                                                None) is not None else None,
        ExceptionDetails.from_json(json['exceptionDetails']) if json.get('exceptionDetails', None) is not None else None
    )
...
def get_exception_details(
    ...
    **EXPERIMENTAL**
    ...
    json = yield cmd_dict
    return ExceptionDetails.from_json(json['exceptionDetails']) if json.get('exceptionDetails',
                                                                            None) is not None else None
