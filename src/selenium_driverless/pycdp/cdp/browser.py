...
class Bounds:
    ...
    def from_json(cls, json: T_JSON_DICT) -> Bounds:
        return cls(
            ...
            window_state=WindowState.from_json(json['windowState']) if json.get('windowState',
...
class PermissionDescriptor:
    ...
    def from_json(cls, json: T_JSON_DICT) -> PermissionDescriptor:
        return cls(
            ...
            allow_without_sanitization=bool(json['allowWithoutSanitization']) if json.get('allowWithoutSanitization',
                                                                                          None) is not None else None,
