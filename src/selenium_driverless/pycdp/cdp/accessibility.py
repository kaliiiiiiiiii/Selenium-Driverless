...
class AXValueSource:
    ...
    def from_json(cls, json: T_JSON_DICT) -> AXValueSource:
        return cls(
            ...
            attribute_value=AXValue.from_json(json['attributeValue']) if json.get('attributeValue',
                                                                                  None) is not None else None,
            superseded=bool(json['superseded']) if json.get('superseded', None) is not None else None,
            native_source=AXValueNativeSourceType.from_json(json['nativeSource']) if json.get('nativeSource',
                                                                                              None) is not None else None,
            native_source_value=AXValue.from_json(json['nativeSourceValue']) if json.get('nativeSourceValue',
                                                                                         None) is not None else None,
...
class AXValue:
    ...
    def from_json(cls, json: T_JSON_DICT) -> AXValue:
        return cls(
            ...
            related_nodes=[AXRelatedNode.from_json(i) for i in json['relatedNodes']] if json.get('relatedNodes',
                                                                                                 None) is not None else None,
            sources=[AXValueSource.from_json(i) for i in json['sources']] if json.get('sources',
                                                                                      None) is not None else None,
        )
...
class AXNode:
    ...
    def from_json(cls, json: T_JSON_DICT) -> AXNode:
        return cls(
            ...
            ignored_reasons=[AXProperty.from_json(i) for i in json['ignoredReasons']] if json.get('ignoredReasons',
                                                                                                  None) is not None else None,
            ...
            value=AXValue.from_json(json['value']) if json.get('value', None) is not None else None,
            properties=[AXProperty.from_json(i) for i in json['properties']] if json.get('properties',
                                                                                         None) is not None else None,
            parent_id=AXNodeId.from_json(json['parentId']) if json.get('parentId', None) is not None else None,
            child_ids=[AXNodeId.from_json(i) for i in json['childIds']] if json.get('childIds',
                                                                                    None) is not None else None,
            backend_dom_node_id=dom.BackendNodeId.from_json(json['backendDOMNodeId']) if json.get('backendDOMNodeId',
                                                                                                  None) is not None else None,
