...
class BaseAudioContext:
    ...
    def from_json(cls, json: T_JSON_DICT) -> BaseAudioContext:
        return cls(
            ...
            realtime_data=ContextRealtimeData.from_json(json['realtimeData']) if json.get('realtimeData',
...
class NodesConnected:
    ...
    def from_json(cls, json: T_JSON_DICT) -> NodesConnected:
        return cls(
            ...
            source_output_index=float(json['sourceOutputIndex']) if json.get('sourceOutputIndex',
                                                                             None) is not None else None,
            destination_input_index=float(json['destinationInputIndex']) if json.get('destinationInputIndex',
                                                                                     None) is not None else None
        )
