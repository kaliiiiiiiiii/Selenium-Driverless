...
class GridHighlightConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> GridHighlightConfig:
        return cls(
            show_grid_extension_lines=bool(json['showGridExtensionLines']) if json.get('showGridExtensionLines',
                                                                                       None) is not None else None,
            show_positive_line_numbers=bool(json['showPositiveLineNumbers']) if json.get('showPositiveLineNumbers',
                                                                                         None) is not None else None,
            show_negative_line_numbers=bool(json['showNegativeLineNumbers']) if json.get('showNegativeLineNumbers',
                                                                                         None) is not None else None,
            ...
            grid_border_color=dom.RGBA.from_json(json['gridBorderColor']) if json.get('gridBorderColor',
                                                                                      None) is not None else None,
            cell_border_color=dom.RGBA.from_json(json['cellBorderColor']) if json.get('cellBorderColor',
                                                                                      None) is not None else None,
            row_line_color=dom.RGBA.from_json(json['rowLineColor']) if json.get('rowLineColor',
                                                                                None) is not None else None,
            column_line_color=dom.RGBA.from_json(json['columnLineColor']) if json.get('columnLineColor',
                                                                                      None) is not None else None,
            ...
            row_gap_color=dom.RGBA.from_json(json['rowGapColor']) if json.get('rowGapColor',
                                                                              None) is not None else None,
            row_hatch_color=dom.RGBA.from_json(json['rowHatchColor']) if json.get('rowHatchColor',
                                                                                  None) is not None else None,
            column_gap_color=dom.RGBA.from_json(json['columnGapColor']) if json.get('columnGapColor',
                                                                                    None) is not None else None,
            column_hatch_color=dom.RGBA.from_json(json['columnHatchColor']) if json.get('columnHatchColor',
                                                                                        None) is not None else None,
            area_border_color=dom.RGBA.from_json(json['areaBorderColor']) if json.get('areaBorderColor',
                                                                                      None) is not None else None,
            grid_background_color=dom.RGBA.from_json(json['gridBackgroundColor']) if json.get('gridBackgroundColor',
                                                                                              None) is not None else None,
        )
...
class FlexContainerHighlightConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> FlexContainerHighlightConfig:
        return cls(
            container_border=LineStyle.from_json(json['containerBorder']) if json.get('containerBorder',
                                                                                      None) is not None else None,
            line_separator=LineStyle.from_json(json['lineSeparator']) if json.get('lineSeparator',
                                                                                  None) is not None else None,
            item_separator=LineStyle.from_json(json['itemSeparator']) if json.get('itemSeparator',
                                                                                  None) is not None else None,
            main_distributed_space=BoxStyle.from_json(json['mainDistributedSpace']) if json.get('mainDistributedSpace',
                                                                                                None) is not None else None,
            cross_distributed_space=BoxStyle.from_json(json['crossDistributedSpace']) if json.get(
                'crossDistributedSpace', None) is not None else None,
            row_gap_space=BoxStyle.from_json(json['rowGapSpace']) if json.get('rowGapSpace',
                                                                              None) is not None else None,
            column_gap_space=BoxStyle.from_json(json['columnGapSpace']) if json.get('columnGapSpace',
                                                                                    None) is not None else None,
            cross_alignment=LineStyle.from_json(json['crossAlignment']) if json.get('crossAlignment',
                                                                                    None) is not None else None,
        )
...
class FlexItemHighlightConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> FlexItemHighlightConfig:
        return cls(
            base_size_box=BoxStyle.from_json(json['baseSizeBox']) if json.get('baseSizeBox',
                                                                              None) is not None else None,
            base_size_border=LineStyle.from_json(json['baseSizeBorder']) if json.get('baseSizeBorder',
                                                                                     None) is not None else None,
            flexibility_arrow=LineStyle.from_json(json['flexibilityArrow']) if json.get('flexibilityArrow',
                                                                                        None) is not None else None,
        )
...
class HighlightConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> HighlightConfig:
        return cls(
            ...
            show_accessibility_info=bool(json['showAccessibilityInfo']) if json.get('showAccessibilityInfo',
                                                                                    None) is not None else None,
            show_extension_lines=bool(json['showExtensionLines']) if json.get('showExtensionLines',
                                                                              None) is not None else None,
            content_color=dom.RGBA.from_json(json['contentColor']) if json.get('contentColor',
                                                                               None) is not None else None,
            padding_color=dom.RGBA.from_json(json['paddingColor']) if json.get('paddingColor',
                                                                               None) is not None else None,
            ...
            event_target_color=dom.RGBA.from_json(json['eventTargetColor']) if json.get('eventTargetColor',
                                                                                        None) is not None else None,
            shape_color=dom.RGBA.from_json(json['shapeColor']) if json.get('shapeColor', None) is not None else None,
            shape_margin_color=dom.RGBA.from_json(json['shapeMarginColor']) if json.get('shapeMarginColor',
                                                                                        None) is not None else None,
            css_grid_color=dom.RGBA.from_json(json['cssGridColor']) if json.get('cssGridColor',
                                                                                None) is not None else None,
            color_format=ColorFormat.from_json(json['colorFormat']) if json.get('colorFormat',
                                                                                None) is not None else None,
            grid_highlight_config=GridHighlightConfig.from_json(json['gridHighlightConfig']) if json.get(
                'gridHighlightConfig', None) is not None else None,
            flex_container_highlight_config=FlexContainerHighlightConfig.from_json(
                json['flexContainerHighlightConfig']) if json.get('flexContainerHighlightConfig',
                                                                  None) is not None else None,
            flex_item_highlight_config=FlexItemHighlightConfig.from_json(json['flexItemHighlightConfig']) if json.get(
                'flexItemHighlightConfig', None) is not None else None,
            contrast_algorithm=ContrastAlgorithm.from_json(json['contrastAlgorithm']) if json.get('contrastAlgorithm',
                                                                                                  None) is not None else None,
            container_query_container_highlight_config=ContainerQueryContainerHighlightConfig.from_json(
                json['containerQueryContainerHighlightConfig']) if json.get('containerQueryContainerHighlightConfig',
                                                                            None) is not None else None,
        )
...
class ScrollSnapContainerHighlightConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScrollSnapContainerHighlightConfig:
        return cls(
            snapport_border=LineStyle.from_json(json['snapportBorder']) if json.get('snapportBorder',
                                                                                    None) is not None else None,
            snap_area_border=LineStyle.from_json(json['snapAreaBorder']) if json.get('snapAreaBorder',
                                                                                     None) is not None else None,
            scroll_margin_color=dom.RGBA.from_json(json['scrollMarginColor']) if json.get('scrollMarginColor',
                                                                                          None) is not None else None,
            scroll_padding_color=dom.RGBA.from_json(json['scrollPaddingColor']) if json.get('scrollPaddingColor',
                                                                                            None) is not None else None,
        )
...
class HingeConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> HingeConfig:
        return cls(
            ...
            content_color=dom.RGBA.from_json(json['contentColor']) if json.get('contentColor',
                                                                               None) is not None else None,
            outline_color=dom.RGBA.from_json(json['outlineColor']) if json.get('outlineColor',
                                                                               None) is not None else None,
        )
...
class ContainerQueryContainerHighlightConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ContainerQueryContainerHighlightConfig:
        return cls(
            container_border=LineStyle.from_json(json['containerBorder']) if json.get('containerBorder',
                                                                                      None) is not None else None,
            descendant_border=LineStyle.from_json(json['descendantBorder']) if json.get('descendantBorder',
                                                                                        None) is not None else None,
        )
...
class IsolationModeHighlightConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> IsolationModeHighlightConfig:
        return cls(
            resizer_color=dom.RGBA.from_json(json['resizerColor']) if json.get('resizerColor',
                                                                               None) is not None else None,
            resizer_handle_color=dom.RGBA.from_json(json['resizerHandleColor']) if json.get('resizerHandleColor',
                                                                                            None) is not None else None,
