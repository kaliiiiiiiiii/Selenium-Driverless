...
class VirtualAuthenticatorOptions:
    ...
    def from_json(cls, json: T_JSON_DICT) -> VirtualAuthenticatorOptions:
        return cls(
            ...
            ctap2_version=Ctap2Version.from_json(json['ctap2Version']) if json.get('ctap2Version',
                                                                                   None) is not None else None,
            has_resident_key=bool(json['hasResidentKey']) if json.get('hasResidentKey', None) is not None else None,
            has_user_verification=bool(json['hasUserVerification']) if json.get('hasUserVerification',
                                                                                None) is not None else None,
            ...
            automatic_presence_simulation=bool(json['automaticPresenceSimulation']) if json.get(
                'automaticPresenceSimulation', None) is not None else None,
