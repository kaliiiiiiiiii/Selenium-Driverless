...
class TimelineEvent:
    ...
    def from_json(cls, json: T_JSON_DICT) -> TimelineEvent:
        return cls(
            ...
            lcp_details=LargestContentfulPaint.from_json(json['lcpDetails']) if json.get('lcpDetails',
                                                                                         None) is not None else None,
            layout_shift_details=LayoutShift.from_json(json['layoutShiftDetails']) if json.get('layoutShiftDetails',
                                                                                               None) is not None else None,
        )
