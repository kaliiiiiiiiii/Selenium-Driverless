...
class CallFrame:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CallFrame:
        return cls(
            ...
            function_location=Location.from_json(json['functionLocation']) if json.get('functionLocation',
                                                                                       None) is not None else None,
            return_value=runtime.RemoteObject.from_json(json['returnValue']) if json.get('returnValue',
                                                                                         None) is not None else None,
...
class Scope:
    ...
    def from_json(cls, json: T_JSON_DICT) -> Scope:
        return cls(
            ...
            start_location=Location.from_json(json['startLocation']) if json.get('startLocation',
                                                                                 None) is not None else None,
...
def evaluate_on_call_frame(
    ...
    return (
        ...
        runtime.ExceptionDetails.from_json(json['exceptionDetails']) if json.get('exceptionDetails',
                                                                                 None) is not None else None
    )
...
def disassemble_wasm_module(
    ...
    T_JSON_DICT, T_JSON_DICT, typing.Tuple[typing.Optional[str], int, typing.List[int], WasmDisassemblyChunk]]:
    '''
...
def restart_frame(
    ...
    typing.List[CallFrame], typing.Optional[runtime.StackTrace], typing.Optional[runtime.StackTraceId]]]:
    '''
    ...
    return (
        ...
        runtime.StackTrace.from_json(json['asyncStackTrace']) if json.get('asyncStackTrace',
                                                                          None) is not None else None,
        runtime.StackTraceId.from_json(json['asyncStackTraceId']) if json.get('asyncStackTraceId',
                                                                              None) is not None else None
    )
...
def set_script_source(
    ...
    typing.Optional[typing.List[CallFrame]], typing.Optional[bool], typing.Optional[runtime.StackTrace],
    typing.Optional[runtime.StackTraceId], str, typing.Optional[runtime.ExceptionDetails]]]:
    '''
...
class Paused:
    ...
    def from_json(cls, json: T_JSON_DICT) -> Paused:
        return cls(
            ...
            hit_breakpoints=[str(i) for i in json['hitBreakpoints']] if json.get('hitBreakpoints',
                                                                                 None) is not None else None,
            async_stack_trace=runtime.StackTrace.from_json(json['asyncStackTrace']) if json.get('asyncStackTrace',
                                                                                                None) is not None else None,
            async_stack_trace_id=runtime.StackTraceId.from_json(json['asyncStackTraceId']) if json.get(
                'asyncStackTraceId', None) is not None else None,
            async_call_stack_trace_id=runtime.StackTraceId.from_json(json['asyncCallStackTraceId']) if json.get(
                'asyncCallStackTraceId', None) is not None else None
        )
...
class ScriptFailedToParse:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScriptFailedToParse:
        return cls(
            ...
            hash_=str(json['hash']),
            execution_context_aux_data=dict(json['executionContextAuxData']) if json.get('executionContextAuxData',
                                                                                         None) is not None else None,
            ...
            stack_trace=runtime.StackTrace.from_json(json['stackTrace']) if json.get('stackTrace',
                                                                                     None) is not None else None,
            code_offset=int(json['codeOffset']) if json.get('codeOffset', None) is not None else None,
            script_language=ScriptLanguage.from_json(json['scriptLanguage']) if json.get('scriptLanguage',
                                                                                         None) is not None else None,
...
class ScriptParsed:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScriptParsed:
        return cls(
            ...
            script_language=ScriptLanguage.from_json(json['scriptLanguage']) if json.get('scriptLanguage',
                                                                                         None) is not None else None,
            debug_symbols=DebugSymbols.from_json(json['debugSymbols']) if json.get('debugSymbols',
                                                                                   None) is not None else None,
            embedder_name=str(json['embedderName']) if json.get('embedderName', None) is not None else None
        )
