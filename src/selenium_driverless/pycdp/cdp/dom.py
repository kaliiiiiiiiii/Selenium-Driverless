...
class Node:
    ...
    def from_json(cls, json: T_JSON_DICT) -> Node:
        return cls(
            ...
            shadow_root_type=ShadowRootType.from_json(json['shadowRootType']) if json.get('shadowRootType',
                                                                                          None) is not None else None,
            frame_id=page.FrameId.from_json(json['frameId']) if json.get('frameId', None) is not None else None,
            content_document=Node.from_json(json['contentDocument']) if json.get('contentDocument',
                                                                                 None) is not None else None,
            shadow_roots=[Node.from_json(i) for i in json['shadowRoots']] if json.get('shadowRoots',
                                                                                      None) is not None else None,
            template_content=Node.from_json(json['templateContent']) if json.get('templateContent',
                                                                                 None) is not None else None,
            pseudo_elements=[Node.from_json(i) for i in json['pseudoElements']] if json.get('pseudoElements',
                                                                                            None) is not None else None,
            imported_document=Node.from_json(json['importedDocument']) if json.get('importedDocument',
                                                                                   None) is not None else None,
            distributed_nodes=[BackendNode.from_json(i) for i in json['distributedNodes']] if json.get(
                'distributedNodes', None) is not None else None,
            is_svg=bool(json['isSVG']) if json.get('isSVG', None) is not None else None,
            compatibility_mode=CompatibilityMode.from_json(json['compatibilityMode']) if json.get('compatibilityMode',
                                                                                                  None) is not None else None,
            assigned_slot=BackendNode.from_json(json['assignedSlot']) if json.get('assignedSlot',
                                                                                  None) is not None else None,
        )
...
class BoxModel:
    ...
    def from_json(cls, json: T_JSON_DICT) -> BoxModel:
        return cls(
            ...
            shape_outside=ShapeOutsideInfo.from_json(json['shapeOutside']) if json.get('shapeOutside',
                                                                                       None) is not None else None,
        )
