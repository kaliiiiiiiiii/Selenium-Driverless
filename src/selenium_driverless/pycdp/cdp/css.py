...
class CSSStyleSheetHeader:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CSSStyleSheetHeader:
        return cls(
            ...
            owner_node=dom.BackendNodeId.from_json(json['ownerNode']) if json.get('ownerNode',
...
class CSSRule:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CSSRule:
        return cls(
            ...
            style_sheet_id=StyleSheetId.from_json(json['styleSheetId']) if json.get('styleSheetId',
                                                                                    None) is not None else None,
            nesting_selectors=[str(i) for i in json['nestingSelectors']] if json.get('nestingSelectors',
                                                                                     None) is not None else None,
            media=[CSSMedia.from_json(i) for i in json['media']] if json.get('media', None) is not None else None,
            container_queries=[CSSContainerQuery.from_json(i) for i in json['containerQueries']] if json.get(
                'containerQueries', None) is not None else None,
            supports=[CSSSupports.from_json(i) for i in json['supports']] if json.get('supports',
                                                                                      None) is not None else None,
...
class CSSProperty:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CSSProperty:
        return cls(
            ...
            range_=SourceRange.from_json(json['range']) if json.get('range', None) is not None else None,
            longhand_properties=[CSSProperty.from_json(i) for i in json['longhandProperties']] if json.get(
                'longhandProperties', None) is not None else None,
        )
...
class CSSMedia:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CSSMedia:
        return cls(
            ...
            style_sheet_id=StyleSheetId.from_json(json['styleSheetId']) if json.get('styleSheetId',
                                                                                    None) is not None else None,
            media_list=[MediaQuery.from_json(i) for i in json['mediaList']] if json.get('mediaList',
                                                                                        None) is not None else None,
        )
...
class CSSContainerQuery:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CSSContainerQuery:
        return cls(
            ...
            physical_axes=dom.PhysicalAxes.from_json(json['physicalAxes']) if json.get('physicalAxes',
                                                                                       None) is not None else None,
            logical_axes=dom.LogicalAxes.from_json(json['logicalAxes']) if json.get('logicalAxes',
                                                                                    None) is not None else None,
        )
...
class CSSLayerData:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CSSLayerData:
        return cls(
            ...
            sub_layers=[CSSLayerData.from_json(i) for i in json['subLayers']] if json.get('subLayers',
                                                                                          None) is not None else None,
        )
...
class FontFace:
    ...
    def from_json(cls, json: T_JSON_DICT) -> FontFace:
        return cls(
            ...
            font_variation_axes=[FontVariationAxis.from_json(i) for i in json['fontVariationAxes']] if json.get(
                'fontVariationAxes', None) is not None else None,
        )
...
def get_matched_styles_for_node(
    ...
    typing.Optional[CSSStyle], typing.Optional[CSSStyle], typing.Optional[typing.List[RuleMatch]], typing.Optional[
        typing.List[PseudoElementMatches]], typing.Optional[typing.List[InheritedStyleEntry]], typing.Optional[
        typing.List[InheritedPseudoElementMatches]], typing.Optional[typing.List[CSSKeyframesRule]], typing.Optional[
        typing.List[CSSPositionFallbackRule]], typing.Optional[dom.NodeId]]]:
    '''
    ...
    return (
        CSSStyle.from_json(json['inlineStyle']) if json.get('inlineStyle', None) is not None else None,
        CSSStyle.from_json(json['attributesStyle']) if json.get('attributesStyle', None) is not None else None,
        [RuleMatch.from_json(i) for i in json['matchedCSSRules']] if json.get('matchedCSSRules',
                                                                              None) is not None else None,
        [PseudoElementMatches.from_json(i) for i in json['pseudoElements']] if json.get('pseudoElements',
                                                                                        None) is not None else None,
        [InheritedStyleEntry.from_json(i) for i in json['inherited']] if json.get('inherited',
                                                                                  None) is not None else None,
        [InheritedPseudoElementMatches.from_json(i) for i in json['inheritedPseudoElements']] if json.get(
            'inheritedPseudoElements', None) is not None else None,
        [CSSKeyframesRule.from_json(i) for i in json['cssKeyframesRules']] if json.get('cssKeyframesRules',
                                                                                       None) is not None else None,
        [CSSPositionFallbackRule.from_json(i) for i in json['cssPositionFallbackRules']] if json.get(
            'cssPositionFallbackRules', None) is not None else None,
