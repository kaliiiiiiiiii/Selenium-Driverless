...
class LogEntry:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LogEntry:
        return cls(
            ...
            network_request_id=network.RequestId.from_json(json['networkRequestId']) if json.get('networkRequestId',
                                                                                                 None) is not None else None,
            worker_id=str(json['workerId']) if json.get('workerId', None) is not None else None,
            args=[runtime.RemoteObject.from_json(i) for i in json['args']] if json.get('args',
                                                                                       None) is not None else None,
        )
