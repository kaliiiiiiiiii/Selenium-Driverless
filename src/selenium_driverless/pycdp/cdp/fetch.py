...
class RequestPattern:
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestPattern:
        return cls(
            ...
            resource_type=network.ResourceType.from_json(json['resourceType']) if json.get('resourceType',
                                                                                           None) is not None else None,
            request_stage=RequestStage.from_json(json['requestStage']) if json.get('requestStage',
                                                                                   None) is not None else None,
        )
...
class RequestPaused:
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestPaused:
        return cls(
            ...
            response_error_reason=network.ErrorReason.from_json(json['responseErrorReason']) if json.get(
                'responseErrorReason', None) is not None else None,
            response_status_code=int(json['responseStatusCode']) if json.get('responseStatusCode',
                                                                             None) is not None else None,
            response_status_text=str(json['responseStatusText']) if json.get('responseStatusText',
                                                                             None) is not None else None,
            response_headers=[HeaderEntry.from_json(i) for i in json['responseHeaders']] if json.get('responseHeaders',
                                                                                                     None) is not None else None,
            network_id=network.RequestId.from_json(json['networkId']) if json.get('networkId',
                                                                                  None) is not None else None,
            redirected_request_id=RequestId.from_json(json['redirectedRequestId']) if json.get('redirectedRequestId',
                                                                                               None) is not None else None
        )
