...
class UserAgentMetadata:
    ...
    def from_json(cls, json: T_JSON_DICT) -> UserAgentMetadata:
        return cls(
            ...
            brands=[UserAgentBrandVersion.from_json(i) for i in json['brands']] if json.get('brands',
                                                                                            None) is not None else None,
            full_version_list=[UserAgentBrandVersion.from_json(i) for i in json['fullVersionList']] if json.get(
                'fullVersionList', None) is not None else None,
