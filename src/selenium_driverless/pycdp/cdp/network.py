...
class Request:
    ...
    def from_json(cls, json: T_JSON_DICT) -> Request:
        return cls(
            ...
            post_data_entries=[PostDataEntry.from_json(i) for i in json['postDataEntries']] if json.get(
                'postDataEntries', None) is not None else None,
            mixed_content_type=security.MixedContentType.from_json(json['mixedContentType']) if json.get(
                'mixedContentType', None) is not None else None,
            is_link_preload=bool(json['isLinkPreload']) if json.get('isLinkPreload', None) is not None else None,
            trust_token_params=TrustTokenParams.from_json(json['trustTokenParams']) if json.get('trustTokenParams',
...
class SecurityDetails:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SecurityDetails:
        return cls(
            ...
            signed_certificate_timestamp_list=[SignedCertificateTimestamp.from_json(i) for i in
            ...
            key_exchange_group=str(json['keyExchangeGroup']) if json.get('keyExchangeGroup',
                                                                         None) is not None else None,
            mac=str(json['mac']) if json.get('mac', None) is not None else None,
            server_signature_algorithm=int(json['serverSignatureAlgorithm']) if json.get('serverSignatureAlgorithm',
                                                                                         None) is not None else None,
        )
...
class Response:
    ...
    def from_json(cls, json: T_JSON_DICT) -> Response:
        return cls(
            ...
            request_headers=Headers.from_json(json['requestHeaders']) if json.get('requestHeaders',
                                                                                  None) is not None else None,
            request_headers_text=str(json['requestHeadersText']) if json.get('requestHeadersText',
                                                                             None) is not None else None,
            ...
            from_service_worker=bool(json['fromServiceWorker']) if json.get('fromServiceWorker',
                                                                            None) is not None else None,
            from_prefetch_cache=bool(json['fromPrefetchCache']) if json.get('fromPrefetchCache',
                                                                            None) is not None else None,
            ...
            service_worker_response_source=ServiceWorkerResponseSource.from_json(
                json['serviceWorkerResponseSource']) if json.get('serviceWorkerResponseSource',
                                                                 None) is not None else None,
            response_time=TimeSinceEpoch.from_json(json['responseTime']) if json.get('responseTime',
                                                                                     None) is not None else None,
            cache_storage_cache_name=str(json['cacheStorageCacheName']) if json.get('cacheStorageCacheName',
                                                                                    None) is not None else None,
            protocol=str(json['protocol']) if json.get('protocol', None) is not None else None,
            alternate_protocol_usage=AlternateProtocolUsage.from_json(json['alternateProtocolUsage']) if json.get(
                'alternateProtocolUsage', None) is not None else None,
            security_details=SecurityDetails.from_json(json['securityDetails']) if json.get('securityDetails',
                                                                                            None) is not None else None,
        )
...
class Cookie:
    ...
    def from_json(cls, json: T_JSON_DICT) -> Cookie:
        return cls(
            ...
            partition_key_opaque=bool(json['partitionKeyOpaque']) if json.get('partitionKeyOpaque',
                                                                              None) is not None else None,
        )
...
class CookieParam:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CookieParam:
        return cls(
            ...
            source_scheme=CookieSourceScheme.from_json(json['sourceScheme']) if json.get('sourceScheme',
                                                                                         None) is not None else None,
...
class RequestPattern:
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestPattern:
        return cls(
            ...
            resource_type=ResourceType.from_json(json['resourceType']) if json.get('resourceType',
                                                                                   None) is not None else None,
            interception_stage=InterceptionStage.from_json(json['interceptionStage']) if json.get('interceptionStage',
                                                                                                  None) is not None else None,
        )
...
class SignedExchangeError:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SignedExchangeError:
        return cls(
            ...
            error_field=SignedExchangeErrorField.from_json(json['errorField']) if json.get('errorField',
                                                                                           None) is not None else None,
        )
...
class SignedExchangeInfo:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SignedExchangeInfo:
        return cls(
            ...
            security_details=SecurityDetails.from_json(json['securityDetails']) if json.get('securityDetails',
                                                                                            None) is not None else None,
            errors=[SignedExchangeError.from_json(i) for i in json['errors']] if json.get('errors',
                                                                                          None) is not None else None,
        )
...
class CrossOriginOpenerPolicyStatus:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CrossOriginOpenerPolicyStatus:
        return cls(
            ...
            reporting_endpoint=str(json['reportingEndpoint']) if json.get('reportingEndpoint',
                                                                          None) is not None else None,
            report_only_reporting_endpoint=str(json['reportOnlyReportingEndpoint']) if json.get(
                'reportOnlyReportingEndpoint', None) is not None else None,
        )
...
class SecurityIsolationStatus:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SecurityIsolationStatus:
        return cls(
            ...
            coep=CrossOriginEmbedderPolicyStatus.from_json(json['coep']) if json.get('coep',
                                                                                     None) is not None else None,
        )
...
class LoadingFailed:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LoadingFailed:
        return cls(
            ...
            blocked_reason=BlockedReason.from_json(json['blockedReason']) if json.get('blockedReason',
                                                                                      None) is not None else None,
            cors_error_status=CorsErrorStatus.from_json(json['corsErrorStatus']) if json.get('corsErrorStatus',
                                                                                             None) is not None else None
        )
...
class LoadingFinished:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LoadingFinished:
        return cls(
            ...
            timestamp=MonotonicTime.from_json(json['timestamp']),
            encoded_data_length=float(json['encodedDataLength']),
            should_report_corb_blocking=bool(json['shouldReportCorbBlocking']) if json.get('shouldReportCorbBlocking',
                                                                                           None) is not None else None
        )
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestIntercepted:
        return cls(
            ...
            auth_challenge=AuthChallenge.from_json(json['authChallenge']) if json.get('authChallenge',
                                                                                      None) is not None else None,
            response_error_reason=ErrorReason.from_json(json['responseErrorReason']) if json.get('responseErrorReason',
                                                                                                 None) is not None else None,
            response_status_code=int(json['responseStatusCode']) if json.get('responseStatusCode',
                                                                             None) is not None else None,
            response_headers=Headers.from_json(json['responseHeaders']) if json.get('responseHeaders',
                                                                                    None) is not None else None,
            request_id=RequestId.from_json(json['requestId']) if json.get('requestId', None) is not None else None
        )
...
class RequestWillBeSent:
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestWillBeSent:
        return cls(
            ...
            redirect_response=Response.from_json(json['redirectResponse']) if json.get('redirectResponse',
                                                                                       None) is not None else None,
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestWillBeSentExtraInfo:
        return cls(
            ...
            client_security_state=ClientSecurityState.from_json(json['clientSecurityState']) if json.get(
                'clientSecurityState', None) is not None else None,
            site_has_cookie_in_other_partition=bool(json['siteHasCookieInOtherPartition']) if json.get(
                'siteHasCookieInOtherPartition', None) is not None else None
        )
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> ResponseReceivedExtraInfo:
        return cls(
            ...
            headers_text=str(json['headersText']) if json.get('headersText', None) is not None else None,
            cookie_partition_key=str(json['cookiePartitionKey']) if json.get('cookiePartitionKey',
                                                                             None) is not None else None,
            cookie_partition_key_opaque=bool(json['cookiePartitionKeyOpaque']) if json.get('cookiePartitionKeyOpaque',
                                                                                           None) is not None else None
        )
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> SubresourceWebBundleInnerResponseParsed:
        return cls(
            ...
            bundle_request_id=RequestId.from_json(json['bundleRequestId']) if json.get('bundleRequestId',
                                                                                       None) is not None else None
        )
