...
class MixedContentIssueDetails:
    ...
    def from_json(cls, json: T_JSON_DICT) -> MixedContentIssueDetails:
        return cls(
            ...
            resource_type=MixedContentResourceType.from_json(json['resourceType']) if json.get('resourceType',
...
class BlockedByResponseIssueDetails:
    ...
    def from_json(cls, json: T_JSON_DICT) -> BlockedByResponseIssueDetails:
        return cls(
            ...
            parent_frame=AffectedFrame.from_json(json['parentFrame']) if json.get('parentFrame',
                                                                                  None) is not None else None,
            blocked_frame=AffectedFrame.from_json(json['blockedFrame']) if json.get('blockedFrame',
                                                                                    None) is not None else None,
        )
...
class ContentSecurityPolicyIssueDetails:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ContentSecurityPolicyIssueDetails:
        return cls(
            ...
            frame_ancestor=AffectedFrame.from_json(json['frameAncestor']) if json.get('frameAncestor',
                                                                                      None) is not None else None,
            source_code_location=SourceCodeLocation.from_json(json['sourceCodeLocation']) if json.get(
                'sourceCodeLocation', None) is not None else None,
            violating_node_id=dom.BackendNodeId.from_json(json['violatingNodeId']) if json.get('violatingNodeId',
                                                                                               None) is not None else None,
        )
...
class CorsIssueDetails:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CorsIssueDetails:
        return cls(
            ...
            resource_ip_address_space=network.IPAddressSpace.from_json(json['resourceIPAddressSpace']) if json.get(
                'resourceIPAddressSpace', None) is not None else None,
            client_security_state=network.ClientSecurityState.from_json(json['clientSecurityState']) if json.get(
...
class GenericIssueDetails:
    ...
    def from_json(cls, json: T_JSON_DICT) -> GenericIssueDetails:
        return cls(
            ...
            violating_node_id=dom.BackendNodeId.from_json(json['violatingNodeId']) if json.get('violatingNodeId',
                                                                                               None) is not None else None,
            violating_node_attribute=str(json['violatingNodeAttribute']) if json.get('violatingNodeAttribute',
                                                                                     None) is not None else None,
        )
...
class DeprecationIssueDetails:
    ...
    def from_json(cls, json: T_JSON_DICT) -> DeprecationIssueDetails:
        return cls(
            source_code_location=SourceCodeLocation.from_json(json['sourceCodeLocation']),
            type_=str(json['type']),
            affected_frame=AffectedFrame.from_json(json['affectedFrame']) if json.get('affectedFrame',
                                                                                      None) is not None else None,
        )
...
class InspectorIssueDetails:
    ...
    def from_json(cls, json: T_JSON_DICT) -> InspectorIssueDetails:
        return cls(
            cookie_issue_details=CookieIssueDetails.from_json(json['cookieIssueDetails']) if json.get(
                'cookieIssueDetails', None) is not None else None,
            mixed_content_issue_details=MixedContentIssueDetails.from_json(
                json['mixedContentIssueDetails']) if json.get('mixedContentIssueDetails', None) is not None else None,
            blocked_by_response_issue_details=BlockedByResponseIssueDetails.from_json(
                json['blockedByResponseIssueDetails']) if json.get('blockedByResponseIssueDetails',
                                                                   None) is not None else None,
            heavy_ad_issue_details=HeavyAdIssueDetails.from_json(json['heavyAdIssueDetails']) if json.get(
                'heavyAdIssueDetails', None) is not None else None,
            content_security_policy_issue_details=ContentSecurityPolicyIssueDetails.from_json(
                json['contentSecurityPolicyIssueDetails']) if json.get('contentSecurityPolicyIssueDetails',
                                                                       None) is not None else None,
            shared_array_buffer_issue_details=SharedArrayBufferIssueDetails.from_json(
                json['sharedArrayBufferIssueDetails']) if json.get('sharedArrayBufferIssueDetails',
                                                                   None) is not None else None,
            twa_quality_enforcement_details=TrustedWebActivityIssueDetails.from_json(
                json['twaQualityEnforcementDetails']) if json.get('twaQualityEnforcementDetails',
                                                                  None) is not None else None,
            low_text_contrast_issue_details=LowTextContrastIssueDetails.from_json(
                json['lowTextContrastIssueDetails']) if json.get('lowTextContrastIssueDetails',
                                                                 None) is not None else None,
            cors_issue_details=CorsIssueDetails.from_json(json['corsIssueDetails']) if json.get('corsIssueDetails',
                                                                                                None) is not None else None,
            attribution_reporting_issue_details=AttributionReportingIssueDetails.from_json(
                json['attributionReportingIssueDetails']) if json.get('attributionReportingIssueDetails',
                                                                      None) is not None else None,
            quirks_mode_issue_details=QuirksModeIssueDetails.from_json(json['quirksModeIssueDetails']) if json.get(
                'quirksModeIssueDetails', None) is not None else None,
            navigator_user_agent_issue_details=NavigatorUserAgentIssueDetails.from_json(
                json['navigatorUserAgentIssueDetails']) if json.get('navigatorUserAgentIssueDetails',
                                                                    None) is not None else None,
            generic_issue_details=GenericIssueDetails.from_json(json['genericIssueDetails']) if json.get(
                'genericIssueDetails', None) is not None else None,
            deprecation_issue_details=DeprecationIssueDetails.from_json(json['deprecationIssueDetails']) if json.get(
                'deprecationIssueDetails', None) is not None else None,
            client_hint_issue_details=ClientHintIssueDetails.from_json(json['clientHintIssueDetails']) if json.get(
                'clientHintIssueDetails', None) is not None else None,
            federated_auth_request_issue_details=FederatedAuthRequestIssueDetails.from_json(
                json['federatedAuthRequestIssueDetails']) if json.get('federatedAuthRequestIssueDetails',
                                                                      None) is not None else None,
            bounce_tracking_issue_details=BounceTrackingIssueDetails.from_json(
                json['bounceTrackingIssueDetails']) if json.get('bounceTrackingIssueDetails',
                                                                None) is not None else None,
        )
