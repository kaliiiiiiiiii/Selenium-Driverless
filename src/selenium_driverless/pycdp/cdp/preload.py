...
class RuleSet:
    ...
    def from_json(cls, json: T_JSON_DICT) -> RuleSet:
        return cls(
            ...
            error_type=RuleSetErrorType.from_json(json['errorType']) if json.get('errorType',
...
class PreloadingAttemptKey:
    ...
    def from_json(cls, json: T_JSON_DICT) -> PreloadingAttemptKey:
        return cls(
            ...
            url=str(json['url']),
            target_hint=SpeculationTargetHint.from_json(json['targetHint']) if json.get('targetHint',
                                                                                        None) is not None else None,
        )
...
class PrerenderAttemptCompleted:
    ...
    def from_json(cls, json: T_JSON_DICT) -> PrerenderAttemptCompleted:
        return cls(
            ...
            disallowed_api_method=str(json['disallowedApiMethod']) if json.get('disallowedApiMethod',
                                                                               None) is not None else None
        )
