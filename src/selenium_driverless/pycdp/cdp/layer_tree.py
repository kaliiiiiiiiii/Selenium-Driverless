...
class StickyPositionConstraint:
    ...
    def from_json(cls, json: T_JSON_DICT) -> StickyPositionConstraint:
        return cls(
            ...
            nearest_layer_shifting_sticky_box=LayerId.from_json(json['nearestLayerShiftingStickyBox']) if json.get(
                'nearestLayerShiftingStickyBox', None) is not None else None,
            nearest_layer_shifting_containing_block=LayerId.from_json(
                json['nearestLayerShiftingContainingBlock']) if json.get('nearestLayerShiftingContainingBlock',
...
class Layer:
    ...
    def from_json(cls, json: T_JSON_DICT) -> Layer:
        return cls(
            ...
            parent_layer_id=LayerId.from_json(json['parentLayerId']) if json.get('parentLayerId',
                                                                                 None) is not None else None,
            ...
            scroll_rects=[ScrollRect.from_json(i) for i in json['scrollRects']] if json.get('scrollRects',
                                                                                            None) is not None else None,
            sticky_position_constraint=StickyPositionConstraint.from_json(json['stickyPositionConstraint']) if json.get(
                'stickyPositionConstraint', None) is not None else None,
        )
