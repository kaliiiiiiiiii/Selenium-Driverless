...
class DOMNode:
    ...
    def from_json(cls, json: T_JSON_DICT) -> DOMNode:
        return cls(
            ...
            child_node_indexes=[int(i) for i in json['childNodeIndexes']] if json.get('childNodeIndexes',
                                                                                      None) is not None else None,
            attributes=[NameValue.from_json(i) for i in json['attributes']] if json.get('attributes',
                                                                                        None) is not None else None,
            pseudo_element_indexes=[int(i) for i in json['pseudoElementIndexes']] if json.get('pseudoElementIndexes',
                                                                                              None) is not None else None,
            ...
            content_document_index=int(json['contentDocumentIndex']) if json.get('contentDocumentIndex',
                                                                                 None) is not None else None,
            pseudo_type=dom.PseudoType.from_json(json['pseudoType']) if json.get('pseudoType',
                                                                                 None) is not None else None,
            shadow_root_type=dom.ShadowRootType.from_json(json['shadowRootType']) if json.get('shadowRootType',
                                                                                              None) is not None else None,
            is_clickable=bool(json['isClickable']) if json.get('isClickable', None) is not None else None,
            event_listeners=[dom_debugger.EventListener.from_json(i) for i in json['eventListeners']] if json.get(
                'eventListeners', None) is not None else None,
            current_source_url=str(json['currentSourceURL']) if json.get('currentSourceURL',
                                                                         None) is not None else None,
...
class LayoutTreeNode:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LayoutTreeNode:
        return cls(
            ...
            inline_text_nodes=[InlineTextBox.from_json(i) for i in json['inlineTextNodes']] if json.get(
                'inlineTextNodes', None) is not None else None,
            ...
            is_stacking_context=bool(json['isStackingContext']) if json.get('isStackingContext',
                                                                            None) is not None else None,
        )
...
class NodeTreeSnapshot:
    ...
    def from_json(cls, json: T_JSON_DICT) -> NodeTreeSnapshot:
        return cls(
            ...
            shadow_root_type=RareStringData.from_json(json['shadowRootType']) if json.get('shadowRootType',
                                                                                          None) is not None else None,
            node_name=[StringIndex.from_json(i) for i in json['nodeName']] if json.get('nodeName',
                                                                                       None) is not None else None,
            node_value=[StringIndex.from_json(i) for i in json['nodeValue']] if json.get('nodeValue',
                                                                                         None) is not None else None,
            backend_node_id=[dom.BackendNodeId.from_json(i) for i in json['backendNodeId']] if json.get('backendNodeId',
                                                                                                        None) is not None else None,
            attributes=[ArrayOfStrings.from_json(i) for i in json['attributes']] if json.get('attributes',
                                                                                             None) is not None else None,
            text_value=RareStringData.from_json(json['textValue']) if json.get('textValue', None) is not None else None,
            input_value=RareStringData.from_json(json['inputValue']) if json.get('inputValue',
                                                                                 None) is not None else None,
            input_checked=RareBooleanData.from_json(json['inputChecked']) if json.get('inputChecked',
                                                                                      None) is not None else None,
            option_selected=RareBooleanData.from_json(json['optionSelected']) if json.get('optionSelected',
                                                                                          None) is not None else None,
            content_document_index=RareIntegerData.from_json(json['contentDocumentIndex']) if json.get(
                'contentDocumentIndex', None) is not None else None,
            pseudo_type=RareStringData.from_json(json['pseudoType']) if json.get('pseudoType',
                                                                                 None) is not None else None,
            pseudo_identifier=RareStringData.from_json(json['pseudoIdentifier']) if json.get('pseudoIdentifier',
                                                                                             None) is not None else None,
            is_clickable=RareBooleanData.from_json(json['isClickable']) if json.get('isClickable',
                                                                                    None) is not None else None,
            current_source_url=RareStringData.from_json(json['currentSourceURL']) if json.get('currentSourceURL',
                                                                                              None) is not None else None,
...
class LayoutTreeSnapshot:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LayoutTreeSnapshot:
        return cls(
            ...
            offset_rects=[Rectangle.from_json(i) for i in json['offsetRects']] if json.get('offsetRects',
                                                                                           None) is not None else None,
            scroll_rects=[Rectangle.from_json(i) for i in json['scrollRects']] if json.get('scrollRects',
                                                                                           None) is not None else None,
            client_rects=[Rectangle.from_json(i) for i in json['clientRects']] if json.get('clientRects',
                                                                                           None) is not None else None,
            blended_background_colors=[StringIndex.from_json(i) for i in json['blendedBackgroundColors']] if json.get(
                'blendedBackgroundColors', None) is not None else None,
            text_color_opacities=[float(i) for i in json['textColorOpacities']] if json.get('textColorOpacities',
                                                                                            None) is not None else None,
        )
