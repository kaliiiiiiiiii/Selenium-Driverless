...
class InterestGroupDetails:
    ...
    def from_json(cls, json: T_JSON_DICT) -> InterestGroupDetails:
        return cls(
            ...
            bidding_wasm_helper_url=str(json['biddingWasmHelperUrl']) if json.get('biddingWasmHelperUrl',
                                                                                  None) is not None else None,
            update_url=str(json['updateUrl']) if json.get('updateUrl', None) is not None else None,
            trusted_bidding_signals_url=str(json['trustedBiddingSignalsUrl']) if json.get('trustedBiddingSignalsUrl',
                                                                                          None) is not None else None,
            user_bidding_signals=str(json['userBiddingSignals']) if json.get('userBiddingSignals',
                                                                             None) is not None else None,
        )
...
class SharedStorageAccessParams:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SharedStorageAccessParams:
        return cls(
            ...
            urls_with_metadata=[SharedStorageUrlWithMetadata.from_json(i) for i in
                                json['urlsWithMetadata']] if json.get('urlsWithMetadata', None) is not None else None,
