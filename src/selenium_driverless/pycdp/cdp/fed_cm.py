...
class Account:
    ...
    def from_json(cls, json: T_JSON_DICT) -> Account:
        return cls(
            ...
            terms_of_service_url=str(json['termsOfServiceUrl']) if json.get('termsOfServiceUrl',
                                                                            None) is not None else None,
            privacy_policy_url=str(json['privacyPolicyUrl']) if json.get('privacyPolicyUrl',
                                                                         None) is not None else None,
        )
