...
class TargetInfo:
    ...
    def from_json(cls, json: T_JSON_DICT) -> TargetInfo:
        return cls(
            ...
            opener_frame_id=page.FrameId.from_json(json['openerFrameId']) if json.get('openerFrameId',
                                                                                      None) is not None else None,
            browser_context_id=browser.BrowserContextID.from_json(json['browserContextId']) if json.get(
                'browserContextId', None) is not None else None,
