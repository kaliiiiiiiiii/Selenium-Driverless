...
class TraceConfig:
    ...
    def from_json(cls, json: T_JSON_DICT) -> TraceConfig:
        return cls(
            ...
            trace_buffer_size_in_kb=float(json['traceBufferSizeInKb']) if json.get('traceBufferSizeInKb',
            ...
            enable_argument_filter=bool(json['enableArgumentFilter']) if json.get('enableArgumentFilter',
                                                                                  None) is not None else None,
            included_categories=[str(i) for i in json['includedCategories']] if json.get('includedCategories',
                                                                                         None) is not None else None,
            excluded_categories=[str(i) for i in json['excludedCategories']] if json.get('excludedCategories',
                                                                                         None) is not None else None,
            synthetic_delays=[str(i) for i in json['syntheticDelays']] if json.get('syntheticDelays',
                                                                                   None) is not None else None,
            memory_dump_config=MemoryDumpConfig.from_json(json['memoryDumpConfig']) if json.get('memoryDumpConfig',
                                                                                                None) is not None else None,
        )
...
class TracingComplete:
    ...
    def from_json(cls, json: T_JSON_DICT) -> TracingComplete:
        return cls(
            ...
            trace_format=StreamFormat.from_json(json['traceFormat']) if json.get('traceFormat',
                                                                                 None) is not None else None,
            stream_compression=StreamCompression.from_json(json['streamCompression']) if json.get('streamCompression',
                                                                                                  None) is not None else None
        )
