...
class CertificateSecurityState:
    ...
    def from_json(cls, json: T_JSON_DICT) -> CertificateSecurityState:
        return cls(
            ...
            certificate_network_error=str(json['certificateNetworkError']) if json.get('certificateNetworkError',
                                                                                       None) is not None else None,
        )
...
class VisibleSecurityState:
    ...
    def from_json(cls, json: T_JSON_DICT) -> VisibleSecurityState:
        return cls(
            ...
            certificate_security_state=CertificateSecurityState.from_json(json['certificateSecurityState']) if json.get(
                'certificateSecurityState', None) is not None else None,
            safety_tip_info=SafetyTipInfo.from_json(json['safetyTipInfo']) if json.get('safetyTipInfo',
                                                                                       None) is not None else None,
        )
...
class SecurityStateExplanation:
    ...
    def from_json(cls, json: T_JSON_DICT) -> SecurityStateExplanation:
        return cls(
            ...
            certificate=[str(i) for i in json['certificate']],
            recommendations=[str(i) for i in json['recommendations']] if json.get('recommendations',
                                                                                  None) is not None else None,
        )
