...
class AdFrameStatus:
    ...
    def from_json(cls, json: T_JSON_DICT) -> AdFrameStatus:
        return cls(
            ...
            explanations=[AdFrameExplanation.from_json(i) for i in json['explanations']] if json.get('explanations',
...
class PermissionsPolicyFeatureState:
    ...
    def from_json(cls, json: T_JSON_DICT) -> PermissionsPolicyFeatureState:
        return cls(
            ...
            locator=PermissionsPolicyBlockLocator.from_json(json['locator']) if json.get('locator',
                                                                                         None) is not None else None,
        )
...
class OriginTrialTokenWithStatus:
    ...
    def from_json(cls, json: T_JSON_DICT) -> OriginTrialTokenWithStatus:
        return cls(
            ...
            parsed_token=OriginTrialToken.from_json(json['parsedToken']) if json.get('parsedToken',
                                                                                     None) is not None else None,
        )
...
class Frame:
    ...
    def from_json(cls, json: T_JSON_DICT) -> Frame:
        return cls(
            ...
            ad_frame_status=AdFrameStatus.from_json(json['adFrameStatus']) if json.get('adFrameStatus',
                                                                                       None) is not None else None,
        )
...
class FrameResource:
    ...
    def from_json(cls, json: T_JSON_DICT) -> FrameResource:
        return cls(
            ...
            mime_type=str(json['mimeType']),
            last_modified=network.TimeSinceEpoch.from_json(json['lastModified']) if json.get('lastModified',
                                                                                             None) is not None else None,
...
class FrameResourceTree:
    ...
    def from_json(cls, json: T_JSON_DICT) -> FrameResourceTree:
        return cls(
            ...
            child_frames=[FrameResourceTree.from_json(i) for i in json['childFrames']] if json.get('childFrames',
                                                                                                   None) is not None else None,
        )
...
class FrameTree:
    ...
    def from_json(cls, json: T_JSON_DICT) -> FrameTree:
        return cls(
            frame=Frame.from_json(json['frame']),
            child_frames=[FrameTree.from_json(i) for i in json['childFrames']] if json.get('childFrames',
                                                                                           None) is not None else None,
        )
...
class ScreencastFrameMetadata:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScreencastFrameMetadata:
        return cls(
            ...
            timestamp=network.TimeSinceEpoch.from_json(json['timestamp']) if json.get('timestamp',
                                                                                      None) is not None else None,
        )
...
def get_app_manifest() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, typing.Tuple[
...
def get_layout_metrics() -> typing.Generator[T_JSON_DICT, T_JSON_DICT, typing.Tuple[
    LayoutViewport, VisualViewport, dom.Rect, LayoutViewport, VisualViewport, dom.Rect]]:
    '''
...
class FileChooserOpened:
    ...
    def from_json(cls, json: T_JSON_DICT) -> FileChooserOpened:
        return cls(
            frame_id=FrameId.from_json(json['frameId']),
            mode=str(json['mode']),
            backend_node_id=dom.BackendNodeId.from_json(json['backendNodeId']) if json.get('backendNodeId',
                                                                                           None) is not None else None
        )
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> BackForwardCacheNotUsed:
        return cls(
            loader_id=network.LoaderId.from_json(json['loaderId']),
            frame_id=FrameId.from_json(json['frameId']),
            not_restored_explanations=[BackForwardCacheNotRestoredExplanation.from_json(i) for i in
